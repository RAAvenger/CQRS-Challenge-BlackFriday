...
using Bogus;
using BlackFriday.DataGenerator;
...
static List<BlackFriday.Domain.Entities.BlackFriday> GetReservations(List<ReservableDailyFood> reservableDailyFoods, int usersCount)
{
    ...
    var reservations = new List<BlackFriday.Domain.Entities.BlackFriday>();
    foreach (var reservableDailyFoodsGroupe in reservableFoodsByDate)
    {
        ...
        foreach (var userId in userIds)
        {
            ...
            reservations.Add(new BlackFriday.Domain.Entities.BlackFriday
            {
